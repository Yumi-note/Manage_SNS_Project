...
6. [ノイズキャンセリング機能を備えた Nothing Headphone A がこれまでの最低価格に値下げされました](#記事-6--ノイズキャンセリング機能を備えた-nothing-headphone-a-がこれまでの最低価格に値下げされました)
7. [Google I/O 2026 ライブ ブログ: Google の基調講演での現地の様子](#記事-7--google-io-2026-ライブ-ブログ-google-の基調講演での現地の様子)
8. [Sony の 1000X The Collection は柔らかく高価です](#記事-8--sony-の-1000x-the-collection-は柔らかく高価です)
9. [Google I/O 2026: すべてのニュースと発表](#記事-9--google-io-2026-すべてのニュースと発表)
10. [AI アナウンサーが卒業式中に名前を間違えて読み飛ばした](#記事-10--ai-アナウンサーが卒業式中に名前を間違えて読み飛ばした)
11. [OpenAIの元スタッフがxAIの劣悪な安全記録がSpaceXのIPOを複雑にする可能性があると警告](#記事-11--openaiの元スタッフがxaiの劣悪な安全記録がspacexのipoを複雑にする可能性があると警告)
12. [ザッカーバーグ家はライフガードを雇っているが、それを「ビーチの水担当者」と呼んでいる](#記事-12--ザッカーバーグ家はライフガードを雇っているが、それを「ビーチの水担当者」と呼んでいる)
...
16. [議会の2026年交通法案に基づき、EVドライバーは年間130ドルを支払うことになる](#記事-16--議会の2026年交通法案に基づき、evドライバーは年間130ドルを支払うことになる)
17. [Civilization VII では、ついに時の試練に耐える文明を構築できるようになりました](#記事-17--civilization-vii-では、ついに時の試練に耐える文明を構築できるようになりました)
18. [電力会社の巨大合併の焦点はデータセンターにある](#記事-18--電力会社の巨大合併の焦点はデータセンターにある)
19. [ヴァスト社は宇宙ステーションに加えて、今後は高出力衛星も建造すると発表](#記事-19--ヴァスト社は宇宙ステーションに加えて、今後は高出力衛星も建造すると発表)
20. [現代のサイバー犯罪情勢を理解する](#記事-20--現代のサイバー犯罪情勢を理解する)
21. [ダウンロード: マスク対アルトマン、戦争用スマート グラス、および Google I/O](#記事-21--ダウンロード-マスク対アルトマン、戦争用スマート-グラス、および-google-io)
22. [Colossal Biosciences は 3D プリントした人工卵殻でニワトリを育てています](#記事-22--colossal-biosciences-は-3d-プリントした人工卵殻でニワトリを育てています)
23. [イーロン・マスクがOpenAIに対する訴訟で敗訴した理由は次のとおりです](#記事-23--イーロン・マスクがopenaiに対する訴訟で敗訴した理由は次のとおりです)
24. [今週 Google に期待できること](#記事-24--今週-google-に期待できること)
25. [Google、Gemini Omni の「any-to-any」AI モデルを発表: 企業が知っておくべきこと](#記事-25--google、gemini-omni-の「any-to-any」ai-モデルを発表-企業が知っておくべきこと)
26. [OpenAI の共同創設者 Andrej Karpathy 氏が Anthropic への入社を発表](#記事-26--openai-の共同創設者-andrej-karpathy-氏が-anthropic-への入社を発表)
27. [エージェント型 AI が企業の検索を限界まで押し上げるにつれて、コンテキスト アーキテクチャが RAG に取って代わりつつあります](#記事-27--エージェント型-ai-が企業の検索を限界まで押し上げるにつれて、コンテキスト-アーキテクチャが-rag-に取って代わりつつあります)
28. [50 日間で 4 件の AI サプライチェーン攻撃により、レッド チームがカバーしていないリリース パイプラインが明らかになった](#記事-28--50-日間で-4-件の-ai-サプライチェーン攻撃により、レッド-チームがカバーしていないリリース-パイプラインが明らかになった)
29. [LangSmith エンジンはエージェントのデバッグ ループを自動的に閉じますが、マルチモデルの企業には依然として中立層が必要です](#記事-29--langsmith-エンジンはエージェントのデバッグ-ループを自動的に閉じますが、マルチモデルの企業には依然として中立層が必要です)
30. [最新のXboxサムスティックトッパーはゴールポストのように見える - Engadget](#記事-30--最新のxboxサムスティックトッパーはゴールポストのように見える---engadget)
31. [Google、Gmail、Docs、Keep にさらに多くの会話機能を導入 - Engadget](#記事-31--google、gmail、docs、keep-にさらに多くの会話機能を導入---engadget)
32. [Ask YouTube があなたの質問に対する回答を動画でまとめています - Engadget](#記事-32--ask-youtube-があなたの質問に対する回答を動画でまとめています---engadget)
33. [Plexの生涯サブスクリプション費用は3倍の750ドルに - Engadget](#記事-33--plexの生涯サブスクリプション費用は3倍の750ドルに---engadget)
34. [任天堂の風変わりな新しいモバイル ゲームはワリオウェアからインスピレーションを得ています - Engadget](#記事-34--任天堂の風変わりな新しいモバイル-ゲームはワリオウェアからインスピレーションを得ています---engadget)
...
### ノイズキャンセリング機能を備えた Nothing Headphone A がこれまでの最低価格に値下げされました

> 原題: *The noise-canceling Nothing Headphone A are down to their lowest price to date*

#### 📝 記事の日本語訳

このトピックからの投稿は、毎日の電子メール ダイジェストとホームページ フィードに追加されます。このトピックからの投稿は、毎日の電子メール ダイジェストとホームページ フィードに追加されます。このトピックからの投稿は、毎日の電子メール ダイジェストとホームページ フィードに追加されます。 AmazonのFire TV Stick 4K MaxやSonos Move 2で節約する方法もあります。

#### 🏢 企業解説リンク

- [Amazon](companies/amazon.html)

🔗 [元記事を読む](https://www.theverge.com/gadgets/932686/nothing-headphone-a-amazon-fire-tv-stick-4k-max-deal-sale)

---

## 記事 7  ｜  The Verge

### Google I/O 2026 ライブ ブログ: Google の基調講演での現地の様子

> 原題: *Google I/O 2026 live blog: On the ground at Google’s keynote*
...
🔗 [元記事を読む](https://www.theverge.com/tech/932275/google-io-2026-live-blog-on-the-ground-at-googles-keynote)
...
Google I/O 2026 は本日開幕し、イベントの基調講演は 5 月 19 日太平洋時間午前 10 時 / 東部時間午後 1 時に予定されています。 Gemini は今年の開発者カンファレンスでも再び中心となることが期待されており、Google は新しいバージョンの AI モデルやよりエージェント的な AI 機能を導入する可能性があります。 Google はすでに Android Show で、AI 生成のウィジェットを含む Android 17 に搭載される多数の AI 機能を披露しました。この基調講演では、検索や他の Google サービスにも同様の更新が行われる可能性があります。また、Google XR のアップデートも入手できる可能性があり、サムスンやグッチのモデルも開発中と伝えられている、いくつかの新しいスマート グラスを垣間見ることもできるかもしれません。 Google の基調講演が終了したらすぐにライブ ストリームに参加してください。ヘイデン・フィールドと私はスタジオで大きなテーマについて話す予定です...
...
### OpenAIの元スタッフがxAIの劣悪な安全記録がSpaceXのIPOを複雑にする可能性があると警告
...
### ザッカーバーグ家はライフガードを雇っているが、それを「ビーチの水担当者」と呼んでいる

> 原題: *The Zuckerbergs Are Hiring a Lifeguard but Calling It a ‘Beach Water Person’*

#### 📝 記事の日本語訳

ザッカーバーグ家のオフィスであるウェスト10に関連したグリーンハウスの新しい求人情報によると、メタの最高経営責任者（CEO）マーク・ザッカーバーグとその妻プリシラ・チャンは、家族が広大な敷地を所有しているハワイ州カウアイ島に拠点を置く、季節限定のオンコールの「ビーチウォーター担当者」を雇用しているという。これは役職としては興味深い選択です。なぜなら、職務内容によれば、この「海水担当者」の主な任務には「ビーチのライフガード」と「プールのライフガード」としての勤務が含まれるからです。いわばライフセーバーです。求人情報には「ボートの甲板員」としての勤務についても触れられており、「スタンドアップパドルボード（SUP）、カヌーパドリング、シュノーケリング、その他の海洋活動」の指導など、追加の職務もいくつか挙げられている。ただし、これらは職務内容における水の安全に関する責任の後に発生します...
...
### 議会の2026年交通法案に基づき、EVドライバーは年間130ドルを支払うことになる

> 原題: *EV drivers will pay $130 a year under Congress' 2026 transportation bill*

#### 📝 記事の日本語訳

政治家らはEVに「道路の使用に対する公平な負担」を払ってもらいたいと述べている。第 119 回議会は、米国 250 年の歴史の中で最も機能不全で生産性が最も低い議会の 1 つであるかもしれないが、合意できることが 1 つあるようだ。それは、電気自動車の所有者に十分な費用がかからないということだ。運輸・インフラ委員会は、今後5年間の陸上輸送に資金を提供する法案を発表し、「米国250周年に向けた比類のないインフラの構築と長期開発法」の規定の中に、EVの所有者に課す年間使用料が含まれている。 「私はアメリカの橋に対する歴史的レベルの投資を非常に誇りに思っています。500億ドル以上というこれはアメリカの歴史の中で最大規模の投資です。そしてビルド・アメリカ...

🔗 [元記事を読む](https://arstechnica.com/cars/2026/05/bipartisan-bill-in-congress-includes-130-annual-ev-registration-fee/)

---

## 記事 17  ｜  Ars Technica

### Civilization VII では、ついに時の試練に耐える文明を構築できるようになりました

> 原題: *Civilization VII finally lets you build a civ that stands the test of time*

#### 📝 記事の日本語訳

Civ 7 の開発者は、ゲームの最も物議を醸した決定を振り返ります。 「時の試練に耐えられる文明を築こう。」それは、35 年と 7 つのメインライン エントリを経て進化してきた長期戦略ゲーム シリーズの最初の作品である Sid Meier's Civilization の箱に書かれた約束でした。 Civ 7 では、プレイヤーが最初に選択した文明をゲーム終了までに 2 回変更するという、新しいプレイ方法が導入されました。多くのプレイヤーは「ちょっと待ってください。私たちは文字通り、時の試練に耐えられる文明をもう構築していません。」と言いました。発売当初のこのような不評を受けて、長年のシリーズファンは、このシリーズが時の試練に耐え続けるのかどうか疑問に思い始めました。今日プレイヤーに提供されるゲームの新しいメジャー アップデートのタイトルが... であるのは明らかに偶然ではありません。

🔗 [元記事を読む](https://arstechnica.com/gaming/2026/05/civilization-vii-finally-lets-you-build-a-civilization-that-stands-the-test-of-time/)
...
「成功している宇宙企業はどれも、その製品は多様化しています。」民間宇宙ステーション開発計画の一環として、ヴァスト・スペース社は小型のデモンストレーション宇宙船を建造し、11月初旬に打ち上げた。その後、この車両は数十のテスト目標を見事に達成し、3 か月後に軌道離脱に成功しました。このミッションは、ヴァスト社のヘイブン-1宇宙ステーションに必要な動力、推進力、追跡、その他多数の技術をテストしたもので、明らかに非常に成功したため、同社はその宇宙飛行能力を他の目的に使用する準備ができています。カリフォルニア州ロングビーチに本拠を置く同社は火曜日、高性能衛星バスの販売を開始する計画を発表した。 「成功している宇宙企業はいずれも、その製品を多様化しています」とマックス・ハオット最高経営責任者は述べています。
...
<p>この機能は、本日 Google の年次 I/O 開発者カンファレンスで正式に発表される<a href="https://9to5google.com/2026/05/11/gemini-omni-video-model-shows-up-with-some-early-demos/">何週間も前に勇敢な AI パワー ユーザーによってすでに発見されていました</a>が、同社の <a href="https://x.com/GoogleDeepMind/status/2056786446636212467?s=20">新しい Gemini Omni モデル</a>は、広範な AI およびテクノロジー市場において、大幅に新しいパラダイムを示します。</p><p>それは、その「オムニ」であるためです...
...
### OpenAI の共同創設者 Andrej Karpathy 氏が Anthropic への入社を発表

> 原題: *OpenAI co-founder Andrej Karpathy announces he's joining Anthropic*

#### 📝 記事の日本語訳

<p>影響力のある 39 歳のスロバキア系カナダ人 AI 研究者であり、<a href="https://www.reddit.com/r/OpenAI/comments/1m80e9g/the_11_cofounders_of_openai_in_2025/">OpenAI の最初の 11 人の共同創設者の 1 人であり、Tesla の AI 部門の元責任者である Andrej Karpathy 氏は、次のように発表しました。 5 月 19 日火曜日、彼がライバルのラボ Anthropic に参加することを発表しました。</p><p>カルパシーとして <a href="https://venturebeat.com/Post 新しい投稿を見る 会話 あなたが再投稿しました Andrej Karpathy @karpathy 個人的な最新情報: 参加しました...

#### 🏢 企業解説リンク

- [OpenAI](companies/openai.html)

🔗 [元記事を読む](https://venturebeat.com/technology/andrej-karpathy-announces-hes-joining-anthropic)
...
### 最新のXboxサムスティックトッパーはゴールポストのように見える - Engadget

> 原題: *The latest Xbox thumbstick topper looks like a goal post - Engadget*

#### 📝 記事の日本語訳

これは、障害のある人向けに設計された他の 6 つのサムスティック トッパーに加わります。 MicrosoftのAbility Summitでは、同社は障害のある人向けにXboxサムスティックトッパーをアップデートしている。 3D プリント可能なアクセサリの全体的なデザインを強化することに加えて、同社は 7 番目の形状をラインナップに追加します。 Microsoft は 2024 年にサムスティック トッパー アクセシビリティ プログラムを開始し、今日の発表はその最初のアップグレードとなります。障害者コミュニティからのフィードバックに基づいて、新しいデザインは耐久性が向上し、特に激しいゲームプレイ中に外れにくいと言われています。その新しい形状については、「ゴールポスト」トッパーにご挨拶ください。 (その名の通り、NFL のプレースキッカーが狙うものに少し似ています。) これは、プレート、ドーム、ナローなど、他の 6 つの形状を結合します。

#### 🏢 企業解説リンク

- [Microsoft](companies/microsoft.html)

🔗 [元記事を読む](https://www.engadget.com/2176671/the-latest-xbox-thumbstick-topper-looks-like-a-goal-post/)

---

## 記事 31  ｜  Engadget

### Google、Gmail、Docs、Keep にさらに多くの会話機能を導入 - Engadget

> 原題: *Google brings more conversational features to Gmail, Docs and Keep - Engadget*

#### 📝 記事の日本語訳

アプリ内のデータから質問に対する答えを引き出すことができます。 Google は、大声で話すことが良いことだと考えており、そのために Gmail、Docs、Keep に Live という形でより多くの会話機能を導入しています。たとえば、Gmail Live を使用すると、受信トレイに自然言語で質問できるため、キーワードを自分で検索する手間が省けます。その例では、空港に急いでいてゲート番号を知る必要があるとします。「私のフライトのゲート番号は何ですか?」とシステムに尋ねるだけで済みます。システムが幻覚を見せていないことを祈りながら。多くの点で、Ask Gemini によく似ていますが、それぞれが問題の特定のアプリに接続されています。これらの機能をいつ利用できるようになるかについて、Google は AI Pro および Ultra のサブスクライバーに展開すると述べています。

#### 🏢 企業解説リンク

- [Google](companies/google.html)

🔗 [元記事を読む](https://www.engadget.com/2176612/google-brings-more-conversational-features-to-gmail-docs-and-keep/)

---

## 記事 32  ｜  Engadget

### Ask YouTube があなたの質問に対する回答を動画でまとめています - Engadget

> 原題: *Ask YouTube compiles video answers to your questions - Engadget*

#### 📝 記事の日本語訳

短い形式と長い形式のコンテンツをまとめます。 Google I/O 2006 で、YouTube はコンテンツ用のさらに多くの AI 検索フックを発表しました。 Google 検索の AI モードと同様に、YouTube 内で会話形式の質問をして、プラットフォーム内で特定の回答やコンテンツを見つけることができるようになりますが、すべてビデオ内で行われます。 Ask YouTube は、長文コンテンツやショート動画など、関連性があると思われる動画をまとめます。結果に基づいてフォローアップの質問をして、動画をさらに絞り込むことができます。 Ask YouTube には、ビデオがあなたの質問に答えているかどうかをよりよく理解するために、短いテキストの要約も含まれています。 Ask YouTube は現在、米国の YouTube Premium メンバーが YouTube Labs ページを通じて利用できます。 Gemini Omni 統合も本日から展開されます。

#### 🏢 企業解説リンク

- [Google](companies/google.html)

🔗 [元記事を読む](https://www.engadget.com/2176557/ask-youtube-compiles-vide-answers-to-your-questions/)

---

## 記事 33  ｜  Engadget

### Plexの生涯サブスクリプション費用は3倍の750ドルに - Engadget

> 原題: *Plex's lifetime subscription cost is tripling to $750 - Engadget*

#### 📝 記事の日本語訳

プレミアム プランの価格は、6 月 30 日午後 8 時 1 分（東部標準時）に値上げされる予定です。独自の個人メディア ストリーミング サーバーを作成できるストリーミング サービスおよびアプリである Plex が、生涯サブスクリプション価格を値上げする予定です。 Web サイトで発表されているように、Plex パスの永久オプションは 7 月 1 日付けで 249.99 ドルから 749.99 ドルに跳ね上がります。プレミアム サブスクリプションでは、リモート ストリーミング、コンテンツのダウンロード、イントロやクレジットをスキップするオプションなどの機能が提供されていますが、Plex では、何千もの映画やテレビ番組へのアクセスや、独自のパーソナル メディア サーバーを無料で作成する機能も引き続き提供しています。生涯サブスクリプション価格の 3 倍は、Plex Premium へのアップグレードを検討している人にとっては大きな飛躍のように感じられますが、同社は、生涯サブスクリプションを購入するオプションを完全に排除することを検討していると述べました。

🔗 [元記事を読む](https://www.engadget.com/2176760/plexs-lifetime-subscription-cost-is-tripling-to-dollar750/)

---

## 記事 34  ｜  Engadget

### 任天堂の風変わりな新しいモバイル ゲームはワリオウェアからインスピレーションを得ています - Engadget

> 原題: *Nintendo's wacky new mobile game takes inspiration from WarioWare - Engadget*

#### 📝 記事の日本語訳

無料でダウンロードできるピクトニコ！写真をミニゲームに変えます。任天堂は、『WarioWare』のようなもののファンを喜ばせる今後のモバイル ゲームを発表しました。ピクトニコ！これは無料でダウンロードできるタイトルで、iOS と Android の両方で 5 月 28 日に利用可能になります。これはまったくばかげているように見え、間違いなく任天堂の最も奇妙な例です。基本的なフックは、プレイヤーが家族や友人の写真を撮ると、ゲームがそれらの写真を、WarioWare フランチャイズのマイクロゲームに似た風変わりなミニゲームに変えるというものです。これらのゲームは 80 種類あり、どれもポートレート写真をめちゃくちゃにするようです。プレイヤーが漫画の食べ物を食べるために人の口を伸ばすゲームと、対象を非常に長い舌を持つ赤ちゃんに変えるゲームがあります。これは厳密にマルチプレイヤーゲームのように見えます...

🔗 [元記事を読む](https://www.engadget.com/2176714/nintendos-wacky-new-mobile-game-takes-inspiration-from-warioware/)
