...
1. [画像 AI モデルがチャットボットのアップグレードを上回り、アプリの成長を促進 |テッククランチ](#記事-1--画像-ai-モデルがチャットボットのアップグレードを上回り、アプリの成長を促進-テッククランチ)
2. [ケイティ・ホーン、新たなベンチャー資金のために10億ドルを調達 |テッククランチ](#記事-2--ケイティ・ホーン、新たなベンチャー資金のために10億ドルを調達-テッククランチ)
3. [ハッカーは今でも cPanel のバグを悪用して、何千もの Web サイトを制御しています。テッククランチ](#記事-3--ハッカーは今でも-cpanel-のバグを悪用して、何千もの-web-サイトを制御しています。テッククランチ)
4. [OpenAI裁判でイーロン・マスク氏の唯一のAI専門家証人はAGIの軍拡競争を懸念 |テッククランチ](#記事-4--openai裁判でイーロン・マスク氏の唯一のai専門家証人はagiの軍拡競争を懸念-テッククランチ)
5. [エンタープライズ AI を所有する競争が深刻になる中、Sierra が 9 億 5,000 万ドルを調達 |テッククランチ](#記事-5--エンタープライズ-ai-を所有する競争が深刻になる中、sierra-が-9-億-5000-万ドルを調達-テッククランチ)
6. [SwitchBotの充電式ボタンプッシャーが20％以上オフでセール中](#記事-6--switchbotの充電式ボタンプッシャーが20以上オフでセール中)
7. [ルンバの生みの親が、毛皮で覆われたロボットの仲間とともに帰ってきた](#記事-7--ルンバの生みの親が、毛皮で覆われたロボットの仲間とともに帰ってきた)
8. [Pixel 11はRAM不足の次の犠牲者になる可能性がある](#記事-8--pixel-11はram不足の次の犠牲者になる可能性がある)
9. [スターウォーズデーのお得なセール](#記事-9--スターウォーズデーのお得なセール)
10. [OpenAI の将来をめぐるイーロン・マスク氏とサム・アルトマン氏の法廷闘争からのライブ最新情報](#記事-10--openai-の将来をめぐるイーロン・マスク氏とサム・アルトマン氏の法廷闘争からのライブ最新情報)
11. [ご自宅のすべてのドアに対応するスマートロックです](#記事-11--ご自宅のすべてのドアに対応するスマートロックです)
12. [罪悪感に悩まされないように、期限内に届く母の日ギフトのベストセール](#記事-12--罪悪感に悩まされないように、期限内に届く母の日ギフトのベストセール)
13. [DHS、反ICE投稿をめぐりカナダ人の活動と位置に関するデータをGoogleに差し出すよう要求](#記事-13--dhs、反ice投稿をめぐりカナダ人の活動と位置に関するデータをgoogleに差し出すよう要求)
14. [この会社はFace IDを見えなくする方法を考え出した](#記事-14--この会社はface-idを見えなくする方法を考え出した)
15. [RFK Jr.の新しいポッドキャストは予想通り奇妙です](#記事-15--rfk-jrの新しいポッドキャストは予想通り奇妙です)
16. [教育におけるChatGPTを宣伝する影響力のある研究が危険信号で撤回](#記事-16--教育におけるchatgptを宣伝する影響力のある研究が危険信号で撤回)
17. [ゲームストップ、eBayに560億ドルを提示、その支払い方法の説明に苦慮](#記事-17--ゲームストップ、ebayに560億ドルを提示、その支払い方法の説明に苦慮)
18. [AMD は Linux に HDMI 2.1 サポートを追加しています。これは Steam Machine にとって朗報です。](#記事-18--amd-は-linux-に-hdmi-21-サポートを追加しています。これは-steam-machine-にとって朗報です。)
19. [Twitter訴訟におけるマスク氏の「第三次世界大戦」の脅威がOpenAI裁判で頭から離れない](#記事-19--twitter訴訟におけるマスク氏の「第三次世界大戦」の脅威がopenai裁判で頭から離れない)
...
25. [シャドウ AI が企業の脅威になるため、Microsoft が Agent 365 のプレビューを終了](#記事-25--シャドウ-ai-が企業の脅威になるため、microsoft-が-agent-365-のプレビューを終了)
26. [エージェント AI の RAG 時代は終わります — 次に来るのは新しいコンパイル段階の知識層です](#記事-26--エージェント-ai-の-rag-時代は終わります--次に来るのは新しいコンパイル段階の知識層です)
27. [Salesforce がエンタープライズ AI を破壊するワークフローを修正するために Agentforce Operations を開始](#記事-27--salesforce-がエンタープライズ-ai-を破壊するワークフローを修正するために-agentforce-operations-を開始)
28. [200,000 台の MCP サーバーで、Anthropic が機能と呼ぶコマンド実行の欠陥が公開される](#記事-28--200000-台の-mcp-サーバーで、anthropic-が機能と呼ぶコマンド実行の欠陥が公開される)
29. [AI の足場層が崩壊しつつあります。 LlamaIndex の CEO が生き残るものについて説明します。](#記事-29--ai-の足場層が崩壊しつつあります。-llamaindex-の-ceo-が生き残るものについて説明します。)
30. [Wholesome Direct が 6 月 6 日に多数の楽しいゲームとともに戻ってきます - Engadget](#記事-30--wholesome-direct-が-6-月-6-日に多数の楽しいゲームとともに戻ってきます---engadget)
31. [iRobot の共同創設者の 1 人が、奇妙な小さなロボットの仲間を作っている - Engadget](#記事-31--irobot-の共同創設者の-1-人が、奇妙な小さなロボットの仲間を作っている---engadget)
32. [ミニ・モーターウェイズはプレイヤーに次の都市マップを投票させている - Engadget](#記事-32--ミニ・モーターウェイズはプレイヤーに次の都市マップを投票させている---engadget)
33. [携帯電話の使用禁止は米国の学生のテストのスコアを向上させなかったことが研究で判明 - Engadget](#記事-33--携帯電話の使用禁止は米国の学生のテストのスコアを向上させなかったことが研究で判明---engadget)
34. [Xbox の Stranger Than Heaven ショーケースを視聴する方法 - Engadget](#記事-34--xbox-の-stranger-than-heaven-ショーケースを視聴する方法---engadget)
