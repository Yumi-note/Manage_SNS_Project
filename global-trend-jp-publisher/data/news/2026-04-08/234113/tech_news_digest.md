...
3. [AI エージェント Poke を使用すると、テキストを送信するのと同じくらい簡単に自動化を設定できます |テッククランチ](#記事-3--ai-エージェント-poke-を使用すると、テキストを送信するのと同じくらい簡単に自動化を設定できます-テッククランチ)
...
30. [今週金曜日には、Samsung の高価な Galaxy Z TriFold を購入するチャンスがもう一度あります](#記事-30--今週金曜日には、samsung-の高価な-galaxy-z-trifold-を購入するチャンスがもう一度あります)
...
33. [4月9日のトリプルアイ・イニシアチブショーケースの視聴方法](#記事-33--4月9日のトリプルアイ・イニシアチブショーケースの視聴方法)
...
### AI エージェント Poke を使用すると、テキストを送信するのと同じくらい簡単に自動化を設定できます |テッククランチ

> 原題: *AI agent Poke makes setting up automations as easy as sending a text | TechCrunch*
