...
## Item 1: OpenAI and Microsoft knew they were starting a ‘doom loop’ for the web
...
## Item 2: Virginia governor creates an AI task force and moves to restrain data centers
...
## Item 3: Disney’s first CTO is Character.AI’s former CEO

### X Draft
Disney’s first CTO is Character.AI’s former CEO
日本視点: 仕事や学習でどう使えるかまで落とすと保存されやすい話題です。
出典: https://www.theverge.com/entertainment/997555/karandeep-anand-disney-character-ai
...
## Item 4: A startup that builds other startups raised $100M, and is all-in on physical AI
...
## Item 5: Anthropic is operating a lab that conducts biology experiments
...
## Item 6: AI hallucination nearly triggers US military operation
